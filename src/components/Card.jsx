function Card({imageURL, pkmnName, onClick}) {
  ...
  return (
    <div className ="bg-[#2A2A40] border border-[#3C3C5A] rounded-2xl shadow-lg p-6 w-64 text-white hover:scale-105 transition-transform duration-200 w-fit px-10" onClick={onClick}>
